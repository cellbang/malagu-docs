...
### Version: v2.2.2
Time: 2021-12-09T04:14:39Z
- `修复` (cli-service) 修复构建时文件目录不存在



### Version: v2.2.1
Time: 2021-12-08T14:15:14Z
...
### Version: v1.40.1
Time: 2021-11-08T02:16:22Z
- `修复` (cli-common) miss typescript package



### Version: v1.40.0
Time: 2021-11-07T15:52:39Z
...
### Version: v1.35.2
Time: 2021-09-14T19:03:10Z
- `修复` (cli-service) 修复 `ts-node` 等模块找不到错误



### Version: v1.35.1
Time: 2021-09-14T18:43:17Z
- `修复` (cli-service) 修复静态模块加载错误


### Version: v1.35.0
Time: 2021-09-12T14:54:05Z
...
### Version: v1.27.4
Time: 2021-07-14T18:52:14Z
- `修复` (rpc) Fix RPC call error



### Version: v1.27.3
Time: 2021-07-13T16:07:18Z
...
### Version: v1.24.1
Time: 2021-06-25T16:01:26Z
- `修复` (cli) 修复 monorepo 应用模板
- `重构` (serve-static) 重构 serve-static 组件(#24)


### Version: v1.24.0
Time: 2021-06-24T13:30:11Z
 
- `新增` (faas-adapter+fc-adapter+lambda-adapater+scf-adapter): 适配 Serverless 场景任务调度
- `新增` (faas-adapter+fc-adapter+lambda-adapter+scf-adapter): Adapt to serverless scenario task scheduling


### Version: v1.23.4
Time: 2021-06-21T12:47:22Z
 
- `重构` (templates): 显示声明代码内所依赖的包，方便在非扁平式依赖的情况下运行 (#30)


### Version: v1.23.3
Time: 2021-06-16T17:35:08Z
...
### Version: v1.22.0
Time: 2021-05-22T17:21:31Z
- `新增` (all) upgrade to webpack5



### Version: v1.21.0
Time: 2021-05-01T08:47:00Z
...
### Version: v1.15.3
Time: 2021-03-08T07:20:32Z
- `修复` (vue) 加载 vue 的样式部分文报错



### Version: v1.15.2
Time: 2021-03-08T06:08:42Z
- `修复` (cli) to fix the error when using hook in `vue-app` template
- `新增` (vue) supports Vue CSS file parsing
...
### Version: v1.15.1
Time: 2021-03-07T15:27:52Z
- `新增` (vue) Update vue configuration file
- `新增` (vue) 更新 vue 配置文件


### Version: v1.15.0
Time: 2021-03-07T14:55:40Z
...
### Version: v1.14.0
Time: 2021-02-27T14:53:01Z
- `新增` (shell) Optimize the display of login status
- `新增` (shell) 优化登录状态的显示


### Version: v1.13.0
Time: 2021-02-20T01:41:11Z
...
### Version: v1.9.1
Time: 2021-01-03T03:13:29Z
- `修复` (cloud) misspelling
...
### Version: v1.8.1
Time: 2020-12-05T17:11:37Z
- `新增` (cli) supports version update notification
- `新增` (cli) 支持版本更新通知


### Version: v1.8.0
Time: 2020-12-05T13:14:37Z
...
### Version: v1.4.1
Time: 2020-11-08T04:16:33Z
- `新增` (cli) Support microservice templates
- `新增` (cli) 支持微服务模板


### Version: v1.4.0
Time: 2020-11-08T02:19:22Z
...
- `新增` (cli) Beautify the command line output log
...
### Version: v0.0.35
Time: 2020-08-12T13:27:57Z
- `修复` (cli) fix class-transformer compilation warning
- `修复` (cli) 修复 class-transformer 编译警告


### Version: v0.0.34
Time: 2020-08-12T12:16:46Z
...
- `新增` (cli) adds the base tag to the default html template to allow the resources in html to be loaded by absolute routing
